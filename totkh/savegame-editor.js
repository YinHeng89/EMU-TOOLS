...
window.addEventListener('load', function(){
	...
	dragMessage.innerHTML='<button class="close" onclick="document.getElementById(\'file-load\').click()"><i class=\"icon disk\"></i> 选择 '+getSavegameAllNames()+'</button> 或者把存档拖到这里';
	...
	warningDialog.innerHTML='修改存档会降低游戏体验，请酌情修改！';
	var divButtons=document.createElement('div');
	divButtons.className='buttons';
	var understandButton=document.createElement('button');
	understandButton.innerHTML='确认修改';
